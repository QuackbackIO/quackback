...
/** One cited source captured on an involvement (a help-center article, a feedback post, an admin-curated snippet, a past-conversation summary, a closed ticket, a changelog entry, or an admin-added web page). `type` mirrors ASSISTANT_CITATION_TYPES (apps/web citation-types.ts). */
