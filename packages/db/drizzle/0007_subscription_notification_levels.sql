...
ADD COLUMN "notify_status_changes" boolean DEFAULT true NOT NULL;
...
SET "notify_comments" = NOT "muted",
    "notify_status_changes" = NOT "muted";

-- Step 3: Drop old index and column
DROP INDEX IF EXISTS "post_subscriptions_post_active_idx";
ALTER TABLE "post_subscriptions" DROP COLUMN "muted";
