 ...
 * for service operations in single-tenant mode.
 */
...
export interface ServiceContext {
  ...
  memberId: MemberId
  /** Member's role (unified: owner/admin/member/user) */
 ...
 *
 * @param validation - Auth validation result containing user and member data
