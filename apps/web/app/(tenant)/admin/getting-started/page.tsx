  ...
  const tasks: OnboardingTask[] = [
    {
      ...
      description:
        'Set up a feedback board where users can submit and vote on ideas',
      icon: MessageSquare,
    ...
    },
    {
      ...
      description:
        'Connect GitHub, Slack, or Discord to streamline your workflow',
      icon: Plug,
      isCompleted: false,
      href: '/admin/settings',
      actionLabel: 'Connect',
    ...
    <main className="mx-auto max-w-2xl px-6 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Complete these steps to set up {organization.name}
        </p>
