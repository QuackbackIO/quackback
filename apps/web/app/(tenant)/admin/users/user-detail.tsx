...
import type { PortalUserDetail, EngagedPost } from '@quackback/domain'
...
export function UserDetail({
  ...
  const canManageRoles = ['owner', 'admin'].includes(currentMemberRole)
        ...
        {canManageRoles && (
          <div className="border-t border-border/50 pt-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Select value={user.role} onValueChange={onRoleChange} disabled={isRoleChangePending}>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will remove the user from your organization. They will lose access to the
                    feedback portal and all their data will remain but they won&apos;t be able to
