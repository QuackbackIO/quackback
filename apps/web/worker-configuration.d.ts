/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 35efcfbb35cdbb01fd66ff57b434c908)
...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    // Secrets (not generated by wrangler types)
    CATALOG_DATABASE_URL: string
    NEON_API_KEY: string
    BETTER_AUTH_SECRET: string
    RESEND_API_KEY: string
    INTEGRATION_ENCRYPTION_KEY: string
    TRANSFER_TOKEN_SECRET: string
  }
}
