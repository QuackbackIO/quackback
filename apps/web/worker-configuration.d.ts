/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 89f785422d3753a57fc8aeac7e6cc82d)
// Runtime types generated with workerd@1.20260120.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/server')
  }
  interface Env {
    HYPERDRIVE_CATALOG: Hyperdrive
    NODE_ENV: ''
    EDITION: ''
    ...
    CLOUD_STRIPE_SECRET_KEY: string
    CLOUD_STRIPE_PUBLISHABLE_KEY: string
    CLOUD_STRIPE_WEBHOOK_SECRET: string
    CLOUD_STRIPE_PRO_PRICE_ID: string
    CLOUD_STRIPE_TEAM_PRICE_ID: string
    CLOUD_STRIPE_ENTERPRISE_PRICE_ID: string
    CLOUD_STRIPE_SEAT_PRO_PRICE_ID: string
    CLOUD_STRIPE_SEAT_TEAM_PRICE_ID: string
    CLOUD_STRIPE_SEAT_ENTERPRISE_PRICE_ID: string
    OPENAI_API_KEY: string
    OPENAI_BASE_URL: string
    UV_CLIENT_ID: string
    UV_CLIENT_SECRET: string
    UV_ACCESS_TOKEN: string
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | 'CLOUD_STRIPE_WEBHOOK_SECRET'
      | 'CLOUD_STRIPE_PRO_PRICE_ID'
      | 'CLOUD_STRIPE_TEAM_PRICE_ID'
      | 'CLOUD_STRIPE_ENTERPRISE_PRICE_ID'
      | 'CLOUD_STRIPE_SEAT_PRO_PRICE_ID'
      | 'CLOUD_STRIPE_SEAT_TEAM_PRICE_ID'
      | 'CLOUD_STRIPE_SEAT_ENTERPRISE_PRICE_ID'
      | 'OPENAI_API_KEY'
      | 'OPENAI_BASE_URL'
      | 'UV_CLIENT_ID'
      | 'UV_CLIENT_SECRET'
