...
import { tenantContextMiddleware } from '@/lib/server/middleware/tenant-context'
...
export const startInstance = createStart(() => {
  return {
    ...
    // request_id and an access log. Tenant resolution second — before CSRF and
    ...
    requestMiddleware: [requestContextMiddleware, tenantContextMiddleware, csrfMiddleware],
