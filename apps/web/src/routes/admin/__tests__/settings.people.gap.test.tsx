...
const { Route } = await import('../settings.people')
...
describe('admin settings.people redirect route', () => {
  it('throws a redirect to /admin/customers/segments', () => {
    expect(() => loader()()).toThrow('REDIRECT')
    expect(mocks.redirect).toHaveBeenCalledWith({ to: '/admin/customers/segments' })
  })
})
