 ...
 *
 * This is billing for *this workspace's* subscription to Quackback. It is not
 * related to `integrations/stripe`, which reads a customer's own payment
 * provider to enrich their feedback.
 *
