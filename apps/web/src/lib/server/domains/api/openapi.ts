...
`.trim(),
    ...
    tags: [
      ...
      { name: 'Users', description: 'Manage portal users and session user helper payloads' },
      { name: 'Members', description: 'Manage workspace members' },
      { name: 'Principals', description: 'Manage human team principals' },
      ...
      { name: 'Admin', description: 'Trusted administrative usage endpoints' },
      { name: 'Audit', description: 'Workspace audit log' },
      { name: 'API Keys', description: 'Scoped API keys (legacy compat + per-key scopes)' },
      { name: 'Webhooks', description: 'Webhook management, delivery audit log, and test tools' },
      { name: 'Conversations', description: 'Manage support conversations' },
      { name: 'Mentions', description: 'Session-authenticated mention helper endpoints' },
      { name: 'Internal', description: 'Session-authenticated internal API endpoints' },
      ...
      { name: 'Widget Profiles', description: 'Widget applications and environment profiles' },
    ],
