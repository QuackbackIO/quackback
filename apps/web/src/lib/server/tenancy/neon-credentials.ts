 ...
 *
 * The registry stores references, never passwords — `docs/tenant-registry-contract.md`
 ...
 * connection**, so without this a busy tenant would hammer the management API.
 */
