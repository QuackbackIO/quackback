...
export const SECRET_REF_SCHEMES = ['neon+role', 'derived+hkdf', 'sealed+aead', 'env'] as const
 ...
 */
const NEON_ROLE_REF_RE =
  /^([a-z0-9][a-z0-9-]{0,62})\/(br-[a-z0-9-]{1,62})\/([a-zA-Z_][a-zA-Z0-9_$]{0,62})$/
