 ...
 *                        run the PostgreSQL job tier.
 * QUACKBACK_ROLE=worker  Run the PostgreSQL job tier + periodic sweepers. Still serves
...
/**
 * Whether this process should consume queues (the PostgreSQL job tier) and run the
