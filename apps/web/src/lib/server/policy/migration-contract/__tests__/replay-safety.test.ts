...
describe('the real corpus', () => {
  ...
  it('the carried cloud stamp and job queue migrations are replay-safe', () => {
  ...
  it('0256 is safe, and its safety is a claim rather than a shape', () => {
  ...
  it('no other migration leans on a @replay claim', () => {
    ...
    //
    // 0253 is argued for on the same grounds as 0256: each is a `DO $$` whose body is guarded by
