...
| `lib/server/functions/assistant-connectors.ts`::reviewConnectorToolsFn | assistant.manage |
...
| `lib/server/functions/assistant-guidance-entries.ts`::listGuidanceEntriesFn | assistant.manage |
| `lib/server/functions/assistant-guidance-entries.ts`::saveGuidanceEntryFn | assistant.manage |
| `lib/server/functions/assistant-guidance-entries.ts`::deleteGuidanceEntryFn | assistant.manage |
...
| `lib/server/functions/assistant-source-use.ts`::updateAssistantSourceUseFn | assistant.manage |
| `lib/server/functions/assistant-source-use.ts`::getArticleAssistantUseLimitsFn | help_center.manage |
| `lib/server/functions/assistant-source-use.ts`::getAssistantKnowledgeSourceFn | assistant.manage |
| `lib/server/functions/assistant-source-use.ts`::listAssistantSourceHealthFn | assistant.manage |
| `lib/server/functions/assistant-source-use.ts`::refreshAssistantSourceIndexFn | assistant.manage |
| `lib/server/functions/assistant-source-use.ts`::getArticleIndexHealthFn | assistant.manage |
...
| `lib/server/functions/conversation.ts`::captureInternalFeedbackFn | post.create |
| `lib/server/functions/conversation.ts`::publishCaptureToBoardFn | post.approve |
...
| `routes/api/widget/quinn-source.ts`::GET | route |
