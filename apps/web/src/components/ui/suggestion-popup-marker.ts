...
// a keypress was spent dismissing one. Kept apart from the positioning code
// so those callers do not load the floating-ui layout engine.
 ...
 * a hidden element around, and a stale marker would make every Escape look like
