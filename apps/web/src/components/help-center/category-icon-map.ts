...
// export. This map covers every icon offered by the category icon picker
// (admin/help-center/category-form-dialog.tsx): any name that can be stored
// on a category must resolve here.
