...
export function IntercomConnectionActions({
  ...
  useEffect(() => {
    const searchParams = search as { intercom?: string }
    if (searchParams.intercom !== 'connected') return
  ...
  const handleConnect = async () => {
    setConnecting(true)
    try {
      const url = await getIntercomConnectUrl()
        ...
        {isConnected && (
          <>
            ...
            <ConfirmDialog
              ...
              description="This will remove the Intercom integration and stop syncing customer data. You can reconnect at any time."
