...
export function GitLabConnectionActions({
  ...
  useEffect(() => {
    const searchParams = search as { gitlab?: string }
    if (searchParams.gitlab !== 'connected') return
  ...
  const handleConnect = async () => {
    setConnecting(true)
    try {
      const url = await getGitLabConnectUrl()
        ...
        {isConnected && (
          <>
            ...
            <ConfirmDialog
              ...
              description="This will remove the GitLab integration and stop all synchronization. You can reconnect at any time."
