...
export function TeamsConnectionActions({
  ...
  useEffect(() => {
    const searchParams = search as { teams?: string }
    if (searchParams.teams !== 'connected') return
        ...
        {isConnected && (
          <>
            ...
            <ConfirmDialog
              ...
              description="This will remove the Teams integration and stop all notifications. You can reconnect at any time."
