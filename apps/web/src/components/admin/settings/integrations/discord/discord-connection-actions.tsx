...
export function DiscordConnectionActions({
  ...
  useEffect(() => {
    const searchParams = search as { discord?: string }
    if (searchParams.discord !== 'connected') return
        ...
        {isConnected && (
          <>
            ...
            <ConfirmDialog
              ...
              description="This will remove the Discord integration and stop all notifications. You can reconnect at any time."
