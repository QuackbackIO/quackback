    ...
    return (
      <a href={`/b/${data.boardSlug}/posts/${data.postId}`} className={shellCls}>
        <div className="flex items-start gap-3 p-3">
          ...
          <div className="flex w-11 shrink-0 flex-col items-center justify-center gap-0.5 rounded-md border border-border/50 bg-muted/40 py-1.5 text-muted-foreground">
