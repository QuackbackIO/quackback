...
const OUT = `${OUT_DIR}/sweep-40be439d.json`
const COOKIE_A = '/tmp/verify-2026-08-15-t1a-40be.cookie'
const COOKIE_E = '/tmp/verify-2026-08-15-t1e-40be.cookie'
const COOKIE_CP = '/tmp/verify-2026-08-15-cp-40be.cookie'
...
const facts = {
  ...
  unit: 'hosted-product-verify-40be439d',
  live: {
