...
const OUT = `${OUT_DIR}/sweep-895b942d.json`
const COOKIE_A = '/tmp/verify-2026-08-15-t1a-895b.cookie'
const COOKIE_E = '/tmp/verify-2026-08-15-t1e-895b.cookie'
const COOKIE_CP = '/tmp/verify-2026-08-15-cp-895b.cookie'
...
const facts = {
  ...
  unit: 'hosted-product-verify-895b942d',
  live: {
    appDigest: 'sha256:895b942d58b548021837e4abcbdf96156410de149b23fcb2f29041ccaac8e1ab',
    webDeploy: '932a38f9',
