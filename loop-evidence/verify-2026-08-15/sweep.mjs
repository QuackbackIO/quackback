...
const OUT = `${OUT_DIR}/sweep.json`
const COOKIE_A = '/tmp/verify-2026-08-15-t1a.cookie'
const COOKIE_E = '/tmp/verify-2026-08-15-t1e.cookie'
const COOKIE_CP = '/tmp/verify-2026-08-15-cp.cookie'
...
const facts = {
  ...
  unit: 'hosted-product-verify-25319ded',
  live: {
    appDigest: 'sha256:25319ded06a84cc0b6be9c95a5c738186210a7cc04ffff382c189dfee439ab86',
    webDeploy: 'c5d64208',
    workerDeploy: '086ed99a',
    hourlyDeploy: 'b48414aa',
    dailyDeploy: '518eae03',
    migratorDeploy: 'e7d2d36a',
    cpDeploy: '1931dc38',
    cpDigest: 'sha256:79030f27',
