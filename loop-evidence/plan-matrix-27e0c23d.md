...
app `532dbe27` / `sha256:27e0c23d…` `us-east4-eqdc4a` and CP `1931dc38`
/ `sha256:79030f27…` (`64ca931`). Exercised via the same-fire Verify
sweep (`sweep-27e0c23d.md` / `sweep-27e0c23d.json`). No payment, no Neon,
instances 19→19.

Fixtures: t1a Growth paid; t1e Pro trial. No unpaid Free `ws-*`. No Scale
host. No canceled host. Self-host not re-walked. Image change this pair
is the widget install Outlet only.
