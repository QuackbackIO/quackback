...
| Plan-matrix critic               | live + spec | `loop-evidence/plan-matrix-40be439d-growth.md`             | **PASS** on `40be439d` / `753d3b86` | t1a Pro + t1e Growth paid. Same-plan 409 both. No unpaid Free / Scale / cancel fixture.                                                                                                                                                        |
