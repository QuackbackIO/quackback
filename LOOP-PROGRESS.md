...
| Verify sweep                     | live        | `loop-evidence/verify-2026-08-15/sweep-40be439d-growth.md`                | **PASS 0 HIGH** on `40be439d`       | Re-signed after t1e Growth pay. Prior `sweep-40be439d.md` is pre-Growth.                                                                                                                                                                       |
...
| Plan-matrix critic               | live + spec | `loop-evidence/plan-matrix-40be439d-growth.md` + `plan-matrix-free-t7.md` | **PASS** on `40be439d` / `753d3b86` | t1a Pro + t1e Growth + t7 Free unpaid (2/50/1). No Scale / cancel fixture.                                                                                                                                                                     |
